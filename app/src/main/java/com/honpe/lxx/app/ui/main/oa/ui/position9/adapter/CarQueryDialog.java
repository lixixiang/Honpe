...
import com.honpe.lxx.app.ui.main.oa.ui.position9.adapter.listener.CommodityPresenterInf;
import com.honpe.lxx.app.ui.main.oa.ui.position9.adapter.listener.OnTagSelectListener;
import com.honpe.lxx.app.ui.main.oa.ui.position9.bean.TagInfo;
import com.honpe.lxx.app.widget.FlowTagLayout;
import com.honpe.lxx.app.widget.dialog.MyDialog;
...
/**
 * @ProjectName: Honpe
 * @CreateDate: 2020/7/20 12:19
 * @Author: 李熙祥
 * @Description: java类作用描述 派车历史记录多项查询
 */
public class CarQueryDialog implements CommodityPresenterInf, View.OnClickListener {
