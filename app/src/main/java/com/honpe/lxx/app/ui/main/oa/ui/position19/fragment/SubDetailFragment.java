...
import com.honpe.lxx.app.ui.main.oa.ui.position19.bean.SubContractDetailBean;
...
public class SubDetailFragment extends BaseBackFragment {
        ...
        EasyHttp.post(Constants.MANAGER_OUTSIDE_APPLYLIST_DETAIL + session)
                ...
                .execute(new SimpleCallBack<String>() {
                    ...
                    public void onSuccess(String s) {
                        ...
                        try {
                            Date mStartDate = DateUtil.setDate(sdf, bean.getData().getApplyTimer());
                            Date mEndDate = DateUtil.setDate(bean.getData().getOrderDeliveryDate());
        ...
        EasyHttp.post(Constants.MANAGER_APPLY_CONFIRM + session)
                ...
                .execute(new SimpleCallBack<String>() {
                    ...
                    public void onSuccess(String s) {
                        ...
                        ToastUtil.getInstance().showToast(bean.getData().getConfirmdetails().get(curPos).getConfirmResult() + "审批");
                    }
                });
    }
    ...
    public class ApproveAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(DensityUtil.dp2px(_mActivity, 20), DensityUtil.dp2px(_mActivity, 20));
            ...
            if (position == 0) {
                ...
                params = new RelativeLayout.LayoutParams(DensityUtil.dp2px(_mActivity, 25), DensityUtil.dp2px(_mActivity, 25));
                holder.ivStatus.setLayoutParams(params);
            }
            return convertView;
        }
