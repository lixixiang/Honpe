package com.honpe.lxx.app.ui.main.logistics.adapter;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position == 0) {
            ...
            FrameLayout.LayoutParams pointParams = new FrameLayout.LayoutParams(
                    DensityUtil.dp2px(context,20), DensityUtil.dp2px(context,20));
            ...
            FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(
                    DensityUtil.dp2px(context,10), DensityUtil.dp2px(context,10));
