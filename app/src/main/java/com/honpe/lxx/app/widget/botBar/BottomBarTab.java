package com.honpe.lxx.app.widget.botBar;
...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        mTvTitle.setTextSize(TypedValue.COMPLEX_UNIT_PX, Utils.getFontSize(40));
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.blue_dark));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.blue_dark));
        } else {
