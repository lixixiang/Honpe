package com.honpe.lxx.app.widget.msgtips;
...
public class QBadgeView extends View implements Badge{
    ...
    private void init() {
        ...
        mBadgeTextSize = Utils.dp2px(getContext(), 11);
        mBadgePadding = Utils.dp2px(getContext(), 5);
        mBadgeNumber = 0;
        mBadgeGravity = Gravity.END | Gravity.TOP;
        mGravityOffsetX = Utils.dp2px(getContext(), 1);
        mGravityOffsetY = Utils.dp2px(getContext(), 1);
        mFinalDragDistance = Utils.dp2px(getContext(), 90);
        mShowShadow = true;
        ...
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_POINTER_DOWN:
                ...
                if (mDraggable && event.getPointerId(event.getActionIndex()) == 0
                    ...
                    mDefalutRadius = Utils.dp2px(getContext(), 7);
    ...
    protected Bitmap createBadgeBitmap() {
        Bitmap bitmap = Bitmap.createBitmap((int) mBadgeBackgroundRect.width() + Utils.dp2px(getContext(), 3),
                (int) mBadgeBackgroundRect.height() + Utils.dp2px(getContext(), 3), Bitmap.Config.ARGB_8888);
    ...
    private void showShadowImpl(boolean showShadow) {
        int x = Utils.dp2px(getContext(), 1);
        int y = Utils.dp2px(getContext(), 1.5f);
        switch (mDragQuadrant) {
            case 1:
                x = Utils.dp2px(getContext(), 1);
                y = Utils.dp2px(getContext(), -1.5f);
                break;
            case 2:
                x = Utils.dp2px(getContext(), -1);
                y = Utils.dp2px(getContext(), -1.5f);
        ...
        mBadgeBackgroundPaint.setShadowLayer(showShadow ? Utils.dp2px(getContext(), 2f)
                : 0, x, y, 0x33000000);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mBadgeText != null) {
            ...
            if (mDraggable && mDragging) {
                ...
                if (mDragOutOfRange = startCircleRadius < Utils.dp2px(getContext(), 1.5f)) {
    ...
    public Badge stroke(int color, float width, boolean isDpValue) {
        ...
        mBackgroundBorderWidth = isDpValue ? Utils.dp2px(getContext(), width) : width;
        invalidate();
        return this;
    }
    ...
    public Badge setBadgeTextSize(float size, boolean isSpValue) {
        mBadgeTextSize = isSpValue ? Utils.dp2px(getContext(), size) : size;
        measureText();
        invalidate();
        return this;
    }
    ...
    public float getBadgeTextSize(boolean isSpValue) {
        return isSpValue ? Utils.px2dip(getContext(), mBadgeTextSize) : mBadgeTextSize;
    }

    @Override
    public Badge setBadgePadding(float padding, boolean isDpValue) {
        mBadgePadding = isDpValue ? Utils.dp2px(getContext(), padding) : padding;
        createClipLayer();
        invalidate();
        return this;
    }
    ...
    public float getBadgePadding(boolean isDpValue) {
        return isDpValue ? Utils.px2dip(getContext(), mBadgePadding) : mBadgePadding;
    }
    ...
    public Badge setGravityOffset(float offsetX, float offsetY, boolean isDpValue) {
        mGravityOffsetX = isDpValue ? Utils.dp2px(getContext(), offsetX) : offsetX;
        mGravityOffsetY = isDpValue ? Utils.dp2px(getContext(), offsetY) : offsetY;
        invalidate();
        return this;
    }
    ...
    public float getGravityOffsetX(boolean isDpValue) {
        return isDpValue ? Utils.px2dip(getContext(), mGravityOffsetX) : mGravityOffsetX;
    }

    @Override
    public float getGravityOffsetY(boolean isDpValue) {
        return isDpValue ? Utils.px2dip(getContext(), mGravityOffsetY) : mGravityOffsetY;
    }
