...
public class Constants {
    ...
    public static final String URL2 = "http://api.honpe.com:8096/";
    public static final String URL3 = "http://192.168.0.248:8096/";
    ...
    //考勤管理
    public static final String CHECK_IN_DATA = URL + "api/oa/attendance/getdayattendancebydept?SessionKey=";
    //考勤部门分组
    public static final String DEPART_GROUP = URL + "api/oa/attendance/PostGetTree?SessionKey=";
    public static final String DEPART_list = URL + "api/erp/crmbasedate/posterpdeptlist?sessionkey=";

    //获取地图
    //1.登录
    public static final String LoginCarURL = header + "user/login.do";
    //2.用户信息
    ...
    //WEB登录
    public static final String WEB_ERP_LOGIN = URL2 + "Login/AppCheckLogin";
    //获取个人流程信息列表，用于流程查询查看  //初始化查询 = 第一次时来界面
    public static final String WEB_LIST = URL2 + "Login/AppTaskList";

    //查询 请假，出差，外出
    public static final String AppTaskList = URL2 + "Login/AppTaskList";

    //删除 请假，出差，外出
    public static final String AppTaskDelete = URL2 + "Login/AppTaskDelete";

    //修改 请假，出差，外出
    public static final String AppTaskMob = URL2 + "Login/AppTaskUpdate";

    //发起 请假，出差，外出
    public static final String TypeAppWorkFlow = URL2 + "Login/AppWorkFlow";

    //WEB测试用
    //点击审批流程
    public static final String AppVerifyWorkFlow = URL2 + "Login/AppVerifyWorkFlow";
    public static final String EmployeePorcessVerify = URL2 + "Login/EmployeePorcessVerify";

    //维修审批权限
    public static final String REPAIR_APPROVAL_PERMISSION = URL + "api/erp/crmbasedate/GetErpEquipmentAuthList?SessionKey=";
    //1.查询维修列表
    public static final String QUERY_THE_MAINTENANCE_LIST = URL + "api/erp/crmbasedate/PostListEquipmentInstall?SessionKey=";
    //2.新增
    public static final String REPAIR_APPROVAL_ADD = URL + "api/erp/crmbasedate/PostAddEquipmentInstallMaintenance?SessionKey=";
    //3.修改自己的
    public static final String MOB_MINE = URL + "api/erp/crmbasedate/PostUpdateEquipmentInstallMaintenance?SessionKey=";
    //4.删除维修单
    public static final String DELETE_REPAIR_NO = URL + "api/erp/CrmBaseDate/PostErpEquipmentDelete?SessionKey=";
    //5.维修单审批
    public static final String PERMISSION_REPAIR_LIST = URL + "api/erp/CrmBaseDate/PostCheckEquipmentInstallMaintenance?SessionKey=";

    //宿舍管理 获取宿舍床位接口
    public static final String AppDormitoryList = URL2 + "Login/AppDormitoryGetBedsTree";
    public static final String AppDormitoryGetTree = URL2 + "Login/AppDormitoryList";
    public static final String AppAllStaff = URL2 + "Login/AppGetDormitoryUser";
    public static final String AppExistDormitoryUser = URL2 + "Login/AppExistDormitoryUser";
    public static final String AppSaveUser = URL2 + "Login/AppSaveUser";

    //查询所有审批订单
    public static final String AppSearchProveList = URL2 + "Login/EmployeePorcessList";
    //食堂食谱
    public static final String LookCanteenMenu = URL2 + "Login/LookCanteenMenu";
    //用餐统计
    public static final String AppGetReportList = URL2 + "Login/AppGetReportList";
    //车辆进出管理
    public static final String AppGetParkCard = URL2 + "Login/AppGetParkCard";
    public static final String AppCarInOut = URL2 + "Login/AppCarInOut";
}
