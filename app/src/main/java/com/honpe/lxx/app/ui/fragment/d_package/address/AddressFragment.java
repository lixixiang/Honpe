...
import com.honpe.lxx.app.ui.fragment.d_package.address.add.AddAddressFragment;
...
public class AddressFragment extends BaseBackFragment {
    ...
    protected void initView() {
       initToolbarNav(homeBack);
        ...
        adapter.addChildClickViewIds(R.id.radio_selectedText,R.id.ll_edite_address,R.id.ll_delete_address);
        ...
        switch (event.getCode()) {
            case FinalClass.Address:
                ...
                if (num == 0) {
                    ...
                    tvThemeAdd.setOnClickListener(new View.OnClickListener() {
                        @Override
