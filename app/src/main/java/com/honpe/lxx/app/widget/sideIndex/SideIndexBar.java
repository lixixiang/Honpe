package com.honpe.lxx.app.widget.sideIndex;
...
public class SideIndexBar extends View {
    ...
    private void init(Context context) {
        ...
        mTextSize = context.getResources().getDimensionPixelSize(R.dimen._10sp);
        ...
        mTextTouchedColor = context.getResources().getColor(R.color.grey_home);
