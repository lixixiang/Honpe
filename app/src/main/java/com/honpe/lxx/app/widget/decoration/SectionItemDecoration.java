...
/**
 * FileName: SectionItemDecoration
 * Author: asus
...
public class SectionItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public SectionItemDecoration(Context context, List<AllNameBean.InfoEntity> data) {
        this.mData = data;
    ...
    public void setData(List<AllNameBean.InfoEntity> data) {
        this.mData = data;
