...
/**
 * FileName: CustomFragment
 * Author: asus
 * Date: 2020/11/18 16:17
 * Description: 客户首页界面
 */
public class CustomHomeFragment extends BaseMainFragment {
    @BindView(R.id.title)
    TextView title;
    ...
    private void initImageView() {
        ...
        subGridView.setVisibility(View.GONE);
