package com.honpe.lxx.app.ui.main.logistics;
...
import com.honpe.lxx.app.ui.main.logistics.adapter.MessListAdapter;
import com.honpe.lxx.app.ui.main.logistics.bean.LogisticsInfoBean;
import com.honpe.lxx.app.ui.main.logistics.db.HandleData;
...
import com.honpe.lxx.app.widget.KdniaoTrackQueryAPI;
...
import static com.honpe.lxx.app.api.FinalClass.RC_CAMERA;
import static com.honpe.lxx.app.api.FinalClass.START_CAMER_RESULT;
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.tv_end:
                ...
                if (str.equals("")) {
                    ToastUtil.getInstance().showToast(R.string.The_tracking_number_cannot_be_empty);
                    return;
                }
                canVis = false;
                checkExpress(str);
